class Pet
  attr_reader :color, :breed #(short for β€attribute readerβ€) method
  attr_accessor :name #kaluptei k to attr_reader k to attr_writer
...
class Cat < Pet # Cat class inherits from Pet
  def speak
    puts "Meow!"
  end
end
